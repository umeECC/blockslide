...
StageScript stage5Script[] = {
   ...
   /* SET_OBJ(1, 352,  88, set_invwall, TYPE_WALL),
    ...
    SET_OBJ(1, 736,  88, set_goal, TYPE_WALL),
    ...
    SET_OBJ(1,288,280,set_goal,TYPE_WALL),
    ...
    //SET_OBJ(1,)
    SET_OBJ(1,288,472,set_wall,TYPE_WALL),
    SET_OBJ(1,928,472,set_goal,TYPE_WALL),
    SET_OBJ(1,736,472,set_hako,TYPE_WALL),
    SET_OBJ(1,416,472,set_hako,TYPE_WALL),
    SET_OBJ(1,352,408,set_hako,TYPE_WALL),
    SET_OBJ(1,928,536,set_wall,TYPE_WALL),
   ...
   // SET_OBJ(1, 288, 280, set_wall, TYPE_WALL),
    ...
    SET_OBJ(1, 288, 472, set_wall, TYPE_WALL),
    SET_OBJ(1, 288, 536, set_wall, TYPE_WALL),
    SET_OBJ(1, 352,600, set_wall, TYPE_WALL),
    SET_OBJ(1, 416, 600, set_wall, TYPE_WALL),
    SET_OBJ(1, 480, 600, set_wall, TYPE_WALL),
    SET_OBJ(1, 544, 600, set_wall, TYPE_WALL),
    SET_OBJ(1, 608, 600, set_wall, TYPE_WALL),
    SET_OBJ(1, 672, 600, set_wall, TYPE_WALL),
    SET_OBJ(1, 736, 600, set_wall, TYPE_WALL),
    SET_OBJ(1, 800, 600, set_wall, TYPE_WALL),
    SET_OBJ(1, 864, 600, set_wall, TYPE_WALL),
    SET_OBJ(1, 288, 600, set_wall, TYPE_WALL),
    SET_OBJ(1, 928, 600, set_wall, TYPE_WALL),
