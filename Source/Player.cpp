...
void PlayerManager::init()
{
    ...
    case 1:
        searchSet(playerUpdate, { 544, 470 }); break;
    case 2:
        searchSet(playerUpdate, { 480, 200 }); break;
    case 3:
        searchSet(playerUpdate, { 672, 180 }); break;
    case 4:
        searchSet(playerUpdate, { 736,136 }); break;
    case 5:
        searchSet(playerUpdate, { 864,536 }); break;
    case 6:
        searchSet(playerUpdate, { 736,136 }); break;
    case 7:
        searchSet(playerUpdate, { 736,136 }); break;
    case 8:
        searchSet(playerUpdate, { 448,328 }); break;
    }
}
...
void playerUpdate(OBJ2D* obj)
{
    ...
    case SCENE::GAME:
        ...
        case 3:
            if (isPlayer) {
                setScene(SCENE::CLEAR);  // 最後がプレイヤーのときだけ遷移
            }
            break;
        }
        break;
