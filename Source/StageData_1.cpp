...
StageScript stage1Script[] = {
    ...
    SET_OBJ(1, 576, 104, set_goal,TYPE_GOAL),
    ...
    SET_OBJ(1, 704, 616, set_goal,TYPE_GOAL),
    ...
    SET_OBJ(1, 384, 232, set_goal,TYPE_GOAL),
    ...
    SET_OBJ(1, 640, 488, set_hako,TYPE_WALL),
    
    SET_OBJ(1,330, 300, set_warp,TYPE_WARP),
    SET_END
};
