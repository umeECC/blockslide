...
namespace GameLib
{
    ...
    PadAssign keyAssign00[] = {
        { PAD_UP_KEY        , Keyboard::Up },           // 'VK_UP'
        { PAD_DOWN_KEY      , Keyboard::Down },         // 'VK_DOWN'
        { PAD_LEFT_KEY      , Keyboard::Left },         // 'VK_LEFT'
        { PAD_RIGHT_KEY     , Keyboard::Right },        // 'VK_RIGHT'

        { PAD_START     , Keyboard::Space },        // VK_SPACE
